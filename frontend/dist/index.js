...
(() => {
    ...
    if ((n && typeof n == "object") || typeof n == "function")
      for (let l of Vc(n))
        !Bc.call(e, l) &&
          ...
          Yu(e, l, {
            get: () => n[l],
            enumerable: !(r = Uc(n, l)) || r.enumerable,
          });
    return e;
  };
  var On = (e, n, t) => (
  ...
  var li = je((N) => {
    ...
    N.StrictMode = Qc;
    N.Suspense = Zc;
    N.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = rf;
    ...
    N.isValidElement = Ll;
    N.lazy = function (e) {
      return { $$typeof: qc, _payload: { _status: -1, _result: e }, _init: tf };
    };
    N.memo = function (e, n) {
      return { $$typeof: Jc, type: e, compare: n === void 0 ? null : n };
    };
  ...
  var _c = je((ve) => {
    ...
    function af(e, n, t, r) {
      if (n === null || typeof n > "u" || sf(e, n, t, r)) return !0;
      if (r) return !1;
      if (t !== null)
        switch (t.type) {
          case 3:
...
` + l[u].replace(" at new ", " at ");
    ...
    function yf(e, n, t, r, l, o, u, i, s) {
      (Nt = !1), (Br = null), vf.apply(hf, arguments);
    }
    function gf(e, n, t, r, l, o, u, i, s) {
      if ((yf.apply(this, arguments), Nt)) {
        if (Nt) {
          var f = Br;
          (Nt = !1), (Br = null);
    ...
    var ze = Math.clz32 ? Math.clz32 : Pf,
      xf = Math.log,
      Nf = Math.LN2;
    function Pf(e) {
      return (e >>>= 0), e === 0 ? 32 : (31 - ((xf(e) / Nf) | 0)) | 0;
    }
    var mr = 64,
      vr = 4194304;
    function _t(e) {
    ...
    function vt(e, n) {
      e.blockedOn === n &&
        ...
        No ||
          ((No = !0),
          pe.unstable_scheduleCallback(pe.unstable_NormalPriority, Df)));
    }
    function Vt(e) {
      function n(l) {
        return vt(l, e);
    ...
    function fu(e, n, t, r) {
      if (Qr) {
        ...
        else if (Of(l, e, n, t, r)) r.stopPropagation();
        else if ((zi(e, r), n & 4 && -1 < Rf.indexOf(e))) {
          for (; l !== null; ) {
            var o = bt(l);
            if (
              (o !== null && Zs(o),
    ...
    var it = {
      ...
      Ri = me(fl),
      jf = j({}, fl, { dataTransfer: 0 }),
      Uf = me(jf),
      Vf = j({}, qt, { relatedTarget: 0 }),
      Yl = me(Vf),
      Af = j({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      Bf = me(Af),
      Hf = j({}, it, {
    ...
    var Gf = j({}, qt, {
      ...
      bf = me(qf),
      ed = j({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
      nd = me(ed),
      td = j({}, fl, {
        deltaX: function (e) {
          return "deltaX" in e
    ...
    var od = We && "TextEvent" in window && !Pt,
    ...
    var Le = typeof Object.is == "function" ? Object.is : vd;
    function Bt(e, n) {
      if (Le(e, n)) return !0;
      if (
        typeof e != "object" ||
    ...
    function $i(e, n, t) {
      ...
      (e.currentTarget = t), gf(r, n, void 0, e), (e.currentTarget = null);
    }
    function ya(e, n) {
      n = (n & 4) !== 0;
      ...
      Bs(function () {
        ...
        if (!(n & 7)) {
          e: {
            ...
            if (
              ...
              if (
                ...
                n: {
                  for (k = g, c = S, a = 0, d = k; d; d = In(d)) a++;
          ...
          x &&
            (ra &&
              t.locale !== "ko" &&
              (Un || x !== "onCompositionStart"
                ? x === "onCompositionEnd" && Un && (C = ta())
                : ((nn = m),
...
`,
    ...
    var Do = typeof setTimeout == "function" ? setTimeout : void 0,
      ...
      Ed =
        typeof queueMicrotask == "function"
          ...
          : typeof Yi < "u"
            ? function (e) {
                return Yi.resolve(null).then(e).catch(_d);
              }
            : Do;
    function _d(e) {
      setTimeout(function () {
    ...
    var st = Math.random().toString(36).slice(2),
      Me = "__reactFiber$" + st,
      $t = "__reactProps$" + st,
      $e = "__reactContainer$" + st,
      Mo = "__reactEvents$" + st,
      Cd = "__reactListeners$" + st,
      xd = "__reactHandles$" + st;
    function Sn(e) {
      var n = e[Me];
      if (n) return n;
    ...
    function D(e) {
      0 > Hn || ((e.current = Io[Hn]), (Io[Hn] = null), Hn--);
    }
    function R(e, n) {
      Hn++, (Io[Hn] = e.current), (e.current = n);
    }
    var pn = {},
      ee = vn(pn),
      ie = vn(!1),
    ...
    function wa(e, n, t) {
      ...
      r = r.getChildContext();
      for (var l in r)
        if (!(l in n)) throw Error(h(108, ff(e) || "Unknown", l));
      return j({}, t, r);
    }
    function Zr(e) {
      return (
    ...
    function gu(e) {
      for (; e === Jr; )
        (Jr = Wn[--$n]), (Wn[$n] = null), (qr = Wn[--$n]), (Wn[$n] = null);
      for (; e === Nn; )
        (Nn = ye[--ge]),
          (ye[ge] = null),
          (Be = ye[--ge]),
    ...
    var Pd = Ye.ReactCurrentBatchConfig;
    function xe(e, n) {
      if (e && e.defaultProps) {
    ...
    function ke(e) {
      ...
      if (Su !== e)
        if (((e = { context: e, memoizedValue: n, next: null }), Qn === null)) {
          ...
          (Qn = e), (el.dependencies = { lanes: 0, firstContext: e });
        } else Qn = Qn.next = e;
      return n;
    }
    var kn = null;
    ...
    function Ao(e, n, t, r) {
      ...
      typeof o == "object" && o !== null
        ? (l.context = ke(o))
        : ((o = se(n) ? xn : ee.current), (l.context = nt(e, o))),
    ...
    function Tu(e, n, t, r, l, o) {
      if (
        ...
        (n.updateQueue = null),
        (n.lanes = 0),
        (Mr.current = e === null || e.memoizedState === null ? Od : Dd),
        (e = t(r, l)),
        Lt)
      ) {
        o = 0;
...
` +
    ...
    var Fd = Ye.ReactCurrentOwner,
      ue = !1;
    function te(e, n, t, r) {
      n.child = e === null ? Ta(n, null, t, r) : rt(n, e.child, t, r);
    }
    ...
    function ds(e, n, t, r, l) {
      return tt(), wu(l), (n.flags |= 256), te(e, n, t, r), n.child;
    }
    ...
    function cc(e, n) {
      ...
      switch (e.tag) {
        ...
        case 15:
          ...
          break;
        case 1:
          Ce(n, e), Oe(e), r & 512 && t !== null && Kn(t, t.return);
          break;
        case 5:
          if (
            (Ce(n, e),
    ...
    function ae(e, n) {
      ...
      if (r === 0)
        ...
        if ((t != null && Pi(t), n === 1))
          e.tag === 0 ? Nd(Ss.bind(null, e)) : Sa(Ss.bind(null, e)),
            Ed(function () {
              !(P & 6) && hn();
            }),
            (t = null);
    ...
    function dc(e, n) {
      ...
      if (r & 30 || r & e.expiredLanes || n) n = sl(e, r);
        ...
        P |= 2;
        var o = mc();
        (K !== e || X !== n) && ((Ue = null), (ut = A() + 500), _n(e, n));
        do
          try {
            Yd();
            break;
    ...
    function ju(e, n) {
      ...
      try {
        ...
        (P = t), P === 0 && ((ut = A() + 500), vl && hn());
      }
    }
    function Tn(e) {
      tn !== null && tn.tag === 0 && !(P & 6) && bn();
      var n = P;
      P |= 1;
      var t = Se.transition,
        r = T;
    ...
    function _n(e, n) {
      ...
      if ((t !== -1 && ((e.timeoutHandle = -1), kd(t)), B !== null))
    ...
    function wn(e, n, t) {
      var r = T,
        l = Se.transition;
      try {
        (Se.transition = null), (T = 1), Xd(e, n, t, r);
      } finally {
        (Se.transition = l), (T = r);
      }
      return null;
    ...
    gc = function (e, n, t) {
      if (e !== null)
        if (e.memoizedProps !== n.pendingProps || ie.current) ue = !0;
          ...
          if (!(e.lanes & t) && !(n.flags & 128)) return (ue = !1), Ud(e, n, t);
          ue = !!(e.flags & 131072);
        }
      ...
      switch (((n.lanes = 0), n.tag)) {
        case 2:
          ...
          var l = nt(n, ee.current);
          qn(n, t), (l = Tu(null, n, r, e, l, t));
          var o = Lu();
          return (
            (n.flags |= 1),
            typeof l == "object" &&
          ...
          e: {
            ...
            if (((r = u.element), o.isDehydrated))
              if (
                ...
                (l = ot(Error(h(423)), n)), (n = ds(e, n, r, t, l));
                break e;
              } else if (r !== l) {
                (l = ot(Error(h(424)), n)), (n = ds(e, n, r, t, l));
                break e;
              } else
                for (
        ...
        case 4:
          return (
            xu(n, n.stateNode.containerInfo),
            (r = n.pendingProps),
            e === null ? (n.child = rt(n, null, r, t)) : te(e, n, r, t),
            n.child
          );
        case 11:
          return (
      ...
      switch (e.tag) {
        case 3:
          ...
          if (n.current.memoizedState.isDehydrated) {
            ...
            t !== 0 &&
              (au(n, t | 1), ae(n, A()), !(P & 6) && ((ut = A() + 500), hn()));
          }
          break;
        case 13:
          Tn(function () {
    ...
    Vs = ju;
    As = Tn;
    var lp = { usingClientEntryPoint: !1, Events: [bt, Bn, ml, js, Us, ju] },
      wt = {
      ...
      op = {
        ...
        findFiberByHostInstance: wt.findFiberByHostInstance || tp,
    ...
    if (
      ...
      try {
        (cl = St.inject(op)), (Ie = St);
      } catch {}
    var St;
    ve.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = lp;
  ...
  var Lc = je((xl) => {
    ...
    var up = or(),
      ...
      cp =
        up.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
    ...
    function Tc(e, n, t) {
      ...
      for (r in n) ap.call(n, r) && !fp.hasOwnProperty(r) && (l[r] = n[r]);
      if (e && e.defaultProps)
  ...
  var Dc = On(nr());
  function Oc() {
    return (0, Dc.jsx)("div", { children: "bruh" });
  }
  var Ku = On(nr()),
    dp = (0, Ic.createRoot)(document.getElementById("root"));
  dp.render((0, Ku.jsx)(Mc.StrictMode, { children: (0, Ku.jsx)(Oc, {}) }));
})();
